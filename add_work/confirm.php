...
if ($_SESSION["login"]) {
    ...
    if ($user["role"] == 0) {
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            $st = $db->prepare("SELECT * FROM my_works WHERE name=?");
            $st->execute([$name]);
            ...
            <form action="added.php" method="post" enctype="multipart/form-data">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><img class="preview" src="<?php print ($temp_file_path); ?>" alt="サムネイル"></td>
                        <input type="hidden" name="file" id="file" value="<?php print ($file_name); ?>">
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <input class="outline" type="hidden" name="outline" id="outline"
                            value="<?php print ($outline); ?>">
                    </tr>
                    <tr>
                        <th><label for="created">作成日</label></th>
                        <td><?php print ($created); ?></td>
                        <input type="hidden" name="created" id="created" value="<?php print ($created); ?>">
                    </tr>
                </table>
